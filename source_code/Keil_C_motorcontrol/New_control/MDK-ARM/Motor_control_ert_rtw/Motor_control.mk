###########################################################################
## Makefile generated for Simulink model 'Motor_control'. 
## 
## Makefile     : Motor_control.mk
## Generated on : Wed May 21 20:18:25 2025
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/DELL/Desktop/Keil_C_motorcontrol/New_control/MDK-ARM
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = Motor_control_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Motor_control_ref.rsp
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Motor_control_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Motor_control -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.obj : $(START_DIR)/Motor_control_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
